# Preparando ambiente pra buf para facebook 
...
- **modules**: Directorio donde se encuentran los archivos proto (`v2/types/facebook/proto`)
...
- asegurarte que los archivos generados y los `.proto` sean para estructuras que se encuentran en folder `v2/types/facebook`
-  solo si es contexto de tipos de facebook
