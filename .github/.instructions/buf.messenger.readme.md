# Preparando ambiente pra buf para messenger 
...
- **modules**: Directorio donde se encuentran los archivos proto (`v2/types/messenger/proto`)
...
- asegurarte que los archivos generados y los `.proto` sean para estructuras que se encuentran en folder `v2/types/messenger`
-  solo si es contexto de tipos de messenger
