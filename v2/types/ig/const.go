...
// types media message for instagram
const (
	IG_MEDIA_MESSAGE_TYPE_AUDIO       = "audio"
	IG_MEDIA_MESSAGE_TYPE_IMAGE       = "image"
	IG_MEDIA_MESSAGE_TYPE_VIDEO       = "video"
	IG_MEDIA_MESSAGE_TYPE_FILE        = "file"
	IG_MEDIA_MESSAGE_TYPE_LIKE_HEART  = "like_heart"
	IG_MEDIA_MESSAGE_TYPE_MEDIA_SHARE = "media_share"
